...
unsigned char getSBoxValue(unsigned char num); // declaration
...
int main(int argc , char *argv[]) {
    ...
    expandKey(expandedKey, key, size, expandedKeySize);// initiate
...
// =======
//     xorEncryptDecrypt(buffer, strlen(buffer), "secretkey");
// >>>>>>> ccbac43fff38e730771a2f15aeab8a41daede9c5
